...
const startConf =  () => {
    // sayfaya yeni giren birisi için localstorage ayarları
...
const addTodo = (e) => {
    e.preventDefault();  // bunu yapmamızın sebebi; normal şartlarda formlar submit olunca sayfayı yeniler, bunu yaparak default ettik..
